...
directory_path = glue('{base_path}2_AllcellsVsAllcells_from_MUTPCB_MUTVEHICLE')
...
sig_DEGs_2_AllcellsVsAllcells_from_MUTPCB_MUTVEHICLE = WTvsWT_significant
write.csv(sig_DEGs_2_AllcellsVsAllcells_from_MUTPCB_MUTVEHICLE, file = glue('{directory_path}/sig_DEGs_{dir_name}.csv'))
###########################################
